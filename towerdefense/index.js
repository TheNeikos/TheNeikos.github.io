...
(function() {
  var BaseTower, Checkpoint, Enemy, Game, NormalTower, TempTower, Tower,
  ...
  Tower = (function(_super) {
    ...
    function Tower(grid, io, x, y, width, range, rv) {
      var cellPos;
      if (rv == null) {
        rv = false;
      }
    ...
    Tower.prototype.toggleRangeIndicator = function() {
      var _ref;
      this.rangevisible !== this.rangevisible;
      return this.rangeIndicator.setAlpha((_ref = this.rangevisible) != null ? _ref : {
        1: 0
      });
    };
  ...
  Enemy = (function(_super) {
    ...
    function Enemy(game, speed) {
      var cPos;
      cPos = game.getCheckpoint(0).pos;
      Enemy.__super__.constructor.call(this, game.grid.getCellCenter(cPos), 30);
    ...
    Enemy.prototype.update = function() {
      ...
      if (this.pos.clone().sub(cPos).length() < 2) {
        this.cur_checkpoint++;
        return this.moveToNextCheckpoint();
      }
    };

    Enemy.prototype.moveToNextCheckpoint = function() {
      var nextPos, rot, vel, velX, velY;
      ...
      return this.setVel(vel);
    };

    Enemy.prototype.draw = function() {
      return Enemy.__super__.draw.apply(this, arguments);
    };
  ...
  Game = (function() {
    ...
    Game.prototype.getCheckpoint = function(idx) {
    ...
    Game.prototype.setupMouse = function(io) {
      ...
      io.canvas.addEventListener("contextmenu", (function(_this) {
        return function(e) {
      ...
      return io.canvas.addEventListener("mousedown", (function(_this) {
        return function(e) {
          ...
          if (_this.tempTurret.buildable) {
            ...
            return _this.tempTurret.buildable = false;
          }
        };
      })(this));
    };
